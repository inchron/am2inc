...
#ifndef _AM120_MODEL_FORWARD_HPP
#define _AM120_MODEL_FORWARD_HPP

#include <ecore_forward.hpp> // for EDataTypes

/*PROTECTED REGION ID(am120_model_forward) START*/
...
// EDataType
        /*PROTECTED REGION ID(am120_model_Address) ENABLED START*/
        using Address = long;
        /*PROTECTED REGION END*/
        /*PROTECTED REGION ID(am120_model_PositiveInt) ENABLED START*/
        using PositiveInt = int;
        /*PROTECTED REGION END*/
        /*PROTECTED REGION ID(am120_model_PositiveLong) ENABLED START*/
        using PositiveLong = long;
        /*PROTECTED REGION END*/
        /*PROTECTED REGION ID(am120_model_PositiveDouble) ENABLED START*/
        using PositiveDouble = double;
        /*PROTECTED REGION END*/
        /*PROTECTED REGION ID(am120_model_NonNegativeInt) ENABLED START*/
        using NonNegativeInt = int;
        /*PROTECTED REGION END*/
        /*PROTECTED REGION ID(am120_model_NonNegativeLong) ENABLED START*/
        using NonNegativeLong = long;
        /*PROTECTED REGION END*/
        /*PROTECTED REGION ID(am120_model_NonNegativeDouble) ENABLED START*/
...
#endif // _AM120_MODEL_FORWARD_HPP
