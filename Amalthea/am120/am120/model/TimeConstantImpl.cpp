...
/*
 * am120/model/TimeConstantImpl.cpp
...
{
    // Supertypes
    ::am120::model::ITimeDeviation::_initialize();
...
::am120::model::Time_ptr TimeConstant::getLowerBound()
{
#if 0
...
::am120::model::Time_ptr TimeConstant::getUpperBound()
{
#if 0
    // This is the original body of the EOperation as specified in
    // the ecore. If you want to replace it by C++ code, enable
...
::am120::model::Time_ptr TimeConstant::getAverage()
{
#if 0
    // This is the original body of the EOperation as specified in
    // the ecore. If you want to replace it by C++ code, enable
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am120::model::ModelPackage::TIMECONSTANT__VALUE:
    {
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am120::model::ModelPackage::TIMECONSTANT__VALUE:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am120::model::Time > (_t0);
        setValue(_t1);
    }
        return;
...
::ecore::EClass_ptr TimeConstant::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am120::model::ModelPackage::_instance()->getTimeConstant();
    return _eclass;
}
