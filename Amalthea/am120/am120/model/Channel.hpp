...
#ifndef AM120_MODEL_CHANNEL_HPP
#define AM120_MODEL_CHANNEL_HPP
...
namespace am120
{
    ...
    class EXPORT_AM120_MODEL_DLL Channel : public virtual ::am120::model::AbstractMemoryElement, public virtual ::am120::model::IDisplayName, public virtual ::am120::model::INamespaceMember
    {
    public:
        Channel();
        ...
        // References
        virtual ::am120::model::DataType_ptr getElementType () const;
        virtual void setElementType (::am120::model::DataType_ptr _elementType);

        virtual const ::ecorecpp::mapping::EList< ::am120::model::ChannelAccess_ptr >& getChannelAccesses () const;
        virtual ::ecorecpp::mapping::EList< ::am120::model::ChannelAccess_ptr >& getChannelAccesses ();
    ...
    protected:
        ...
        ::am120::model::DataType_ptr m_elementType;

        ::ecore::EList_ptr< ::am120::model::ChannelAccess_ptr > m_channelAccesses;
