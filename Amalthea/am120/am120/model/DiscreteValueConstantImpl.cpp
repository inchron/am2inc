...
/*
 * am120/model/DiscreteValueConstantImpl.cpp
...
{
    // Supertypes
    ::am120::model::IDiscreteValueDeviation::_initialize();
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am120::model::ModelPackage::DISCRETEVALUECONSTANT__VALUE:
    {
...
::ecore::EClass_ptr DiscreteValueConstant::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am120::model::ModelPackage::_instance()->getDiscreteValueConstant();
    return _eclass;
}
