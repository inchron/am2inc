...
/*
 * am200/model/RunnableParameterImpl.cpp
...
#include <am200/model/IDependsOn.hpp>
#include <am200/model/CustomProperty.hpp>
#include <am200/model/DataDependency.hpp>
#include <am200/model/Runnable.hpp>
#include <am200/model/TypeDefinition.hpp>
...
void RunnableParameter::_initialize()
{
    ...
    ::am200::model::IDependsOn::_initialize();
...
return (_plus + _xifexpression_1);
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: am200::model::RunnableParameter::toString";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DEPENDSON:
    {
        _any = ::ecore::as < ::ecore::EObject > (getDependsOn());
    }
        return _any;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__CONTAININGRUNNABLE:
    {
        _any = ::ecore::as < ::ecore::EObject > (getContainingRunnable());
    }
        return _any;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DIRECTION:
    {
        ::ecorecpp::mapping::any_traits < ::am200::model::DirectionType
                > ::toAny(_any, getDirection());
    }
        return _any;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DATATYPE:
    {
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DEPENDSON:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am200::model::DataDependency > (_t0);
        setDependsOn(_t1);
    }
        return;
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DIRECTION:
    {
        ::am200::model::DirectionType _t0;
        ::ecorecpp::mapping::any_traits < ::am200::model::DirectionType
                > ::fromAny(_newValue, _t0);
        setDirection(_t0);
    }
    ...
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DATATYPE:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am200::model::TypeDefinition > (_t0);
        setDataType(_t1);
    }
        return;
...
::ecore::EBoolean RunnableParameter::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DIRECTION:
        return ::ecorecpp::mapping::set_traits < ::am200::model::DirectionType
                > ::is_set(getDirection());
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__DATATYPE:
...
::ecore::EClass_ptr RunnableParameter::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am200::model::ModelPackage::_instance()->getRunnableParameter();
    return _eclass;
}
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am200::model::ModelPackage::RUNNABLEPARAMETER__CONTAININGRUNNABLE:
    {
        ...
        ::am200::model::Runnable_ptr _t1 = std::dynamic_pointer_cast
                < ::am200::model::Runnable > (_t0);

        ::am200::model::Runnable_ptr _old_containingRunnable =
        ...
        if (_old_containingRunnable && _old_containingRunnable != _t0)
        {
            ...
            _old_containingRunnable->::ecore::EObject::_inverseRemove(
                    ::am200::model::ModelPackage::_instance()->getRunnable__parameters(),
                    _this);
        }
