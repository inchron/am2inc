...
#ifndef AM200_MODEL_MODEVALUE_HPP
#define AM200_MODEL_MODEVALUE_HPP

#include <am200/model/dllModel.hpp>
#include <am200/model_forward.hpp>

#include <ecore_forward.hpp>
#include <am200/model/BaseObject.hpp>
...
namespace am200
{
    ...
    class EXPORT_AM200_MODEL_DLL ModeValue : public virtual ::am200::model::BaseObject
    {
    public:
        ModeValue();
        ...
        virtual ::am200::model::ModeLiteral_ptr getLiteral ();
        ...
        // References
        virtual ::am200::model::ModeLabel_ptr getLabel () const;
        virtual void setLabel (::am200::model::ModeLabel_ptr _label);
    ...
    protected:
        ...
        std::weak_ptr< ::am200::model::ModeLabel > m_label;
...
#endif // AM200_MODEL_MODEVALUE_HPP
