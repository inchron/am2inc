...
/*
 * am200/model/DiscreteValueConstantImpl.cpp
...
{
    // Supertypes
    ::am200::model::IDiscreteValueDeviation::_initialize();
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am200::model::ModelPackage::DISCRETEVALUECONSTANT__VALUE:
    {
...
::ecore::EClass_ptr DiscreteValueConstant::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am200::model::ModelPackage::_instance()->getDiscreteValueConstant();
    return _eclass;
}
