        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am200::model::ModelPackage::NAMESPACE__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am200::model::ModelPackage::NAMESPACE__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am200::model::ModelPackage::NAMESPACE__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am200::model::ModelPackage::NAMESPACE__NEXTSEGMENTS:
    {
        _any = getNextSegments().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am200::model::ModelPackage::NAMESPACE__PREVIOUSSEGMENT:
    {
        _any = ::ecore::as < ::ecore::EObject > (getPreviousSegment());
    }
        return _any;
    case ::am200::model::ModelPackage::NAMESPACE__MEMBEROBJECTS:
    {
...
::ecore::EClass_ptr Namespace::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am200::model::ModelPackage::_instance()->getNamespace();
    return _eclass;
}
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am200::model::ModelPackage::NAMESPACE__NEXTSEGMENTS:
    {
        ...
        ::am200::model::Namespace_ptr _t1 = std::dynamic_pointer_cast
                < ::am200::model::Namespace > (_t0);

        // add to a list
        auto &container =
                (::ecorecpp::mapping::ReferenceEListImpl<
                        ::am200::model::Namespace_ptr, -1, true, true >&) ::am200::model::Namespace::getNextSegments();
    ...
    case ::am200::model::ModelPackage::NAMESPACE__PREVIOUSSEGMENT:
    {
        ...
        ::am200::model::Namespace_ptr _old_previousSegment =
                getPreviousSegment();
        if (_old_previousSegment && _old_previousSegment != _t0)
        {
            ::ecore::EJavaObject _this = ::ecore::EObject::_this();
            _old_previousSegment->::ecore::EObject::_inverseRemove(
                    ::am200::model::ModelPackage::_instance()->getNamespace__nextSegments(),
                    _this);
        }
