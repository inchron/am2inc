...
/*
 * am200/model/TruncatedTimeDistribution.hpp
...
#ifndef AM200_MODEL_TRUNCATEDTIMEDISTRIBUTION_HPP
#define AM200_MODEL_TRUNCATEDTIMEDISTRIBUTION_HPP

#include <am200/model/dllModel.hpp>
#include <am200/model_forward.hpp>

#include <am200/model/ITimeDeviation.hpp>
...
namespace am200
{
    ...
    class EXPORT_AM200_MODEL_DLL TruncatedTimeDistribution : public virtual ::am200::model::ITimeDeviation
    {
    public:
        ...
        // References
        virtual ::am200::model::Time_ptr getLowerBound () const;
        virtual void setLowerBound (::am200::model::Time_ptr _lowerBound);

        virtual ::am200::model::Time_ptr getUpperBound () const;
        virtual void setUpperBound (::am200::model::Time_ptr _upperBound);
         ...
         * defined non-const. */
        ::am200::model::Time_ptr getLowerBound() override
        {
            return const_cast<const TruncatedTimeDistribution*>( this )->getLowerBound();
        }
        ::am200::model::Time_ptr getUpperBound() override
        {
    ...
    protected:
        ...
        ::am200::model::Time_ptr m_lowerBound;

        ::am200::model::Time_ptr m_upperBound;
...
#endif // AM200_MODEL_TRUNCATEDTIMEDISTRIBUTION_HPP
