...
/*
 * am210/model/SubInterfaceImpl.cpp
...
{
    // Supertypes
    ::am210::model::ComponentInterface::_initialize();
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am210::model::ModelPackage::SUBINTERFACE__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am210::model::ModelPackage::SUBINTERFACE__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am210::model::ModelPackage::SUBINTERFACE__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am210::model::ModelPackage::SUBINTERFACE__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am210::model::ModelPackage::SUBINTERFACE__TAGS:
    {
        _any = getTags().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am210::model::ModelPackage::SUBINTERFACE__DATATYPE:
    {
        _any = ::ecore::as < ::ecore::EObject > (getDatatype());
    }
        return _any;
    case ::am210::model::ModelPackage::SUBINTERFACE__SUBINTERFACES:
    {
        _any = getSubInterfaces().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am210::model::ModelPackage::SUBINTERFACE__CONTAININGINTERFACE:
    {
...
::ecore::EClass_ptr SubInterface::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am210::model::ModelPackage::_instance()->getSubInterface();
    return _eclass;
}
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am210::model::ModelPackage::SUBINTERFACE__SUBINTERFACES:
    {
        ...
        ::am210::model::SubInterface_ptr _t1 = std::dynamic_pointer_cast
                < ::am210::model::SubInterface > (_t0);

        // add to a list
        auto &container =
                (::ecorecpp::mapping::ReferenceEListImpl<
                        ::am210::model::SubInterface_ptr, -1, true, true >&) ::am210::model::ComponentInterface::getSubInterfaces();
    ...
    case ::am210::model::ModelPackage::SUBINTERFACE__CONTAININGINTERFACE:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecore::EObject_ptr > (_newValue);
        ::am210::model::ComponentInterface_ptr _t1 = std::dynamic_pointer_cast
                < ::am210::model::ComponentInterface > (_t0);

        ::am210::model::ComponentInterface_ptr _old_containingInterface =
        ...
        if (_old_containingInterface && _old_containingInterface != _t0)
        {
            ...
            _old_containingInterface->::ecore::EObject::_inverseRemove(
                    ::am210::model::ModelPackage::_instance()->getComponentInterface__subInterfaces(),
                    _this);
        }
