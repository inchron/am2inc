...
#include <am210/model/HwFeatureCategory.hpp>
...
return (_plus + _xifexpression_1);
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: am210::model::HwFeature::toString";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am210::model::ModelPackage::HWFEATURE__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am210::model::ModelPackage::HWFEATURE__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am210::model::ModelPackage::HWFEATURE__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am210::model::ModelPackage::HWFEATURE__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am210::model::ModelPackage::HWFEATURE__CONTAININGCATEGORY:
    {
        _any = ::ecore::as < ::ecore::EObject > (getContainingCategory());
    }
        return _any;
    case ::am210::model::ModelPackage::HWFEATURE__VALUE:
    {
...
::ecore::EClass_ptr HwFeature::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am210::model::ModelPackage::_instance()->getHwFeature();
    return _eclass;
}
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am210::model::ModelPackage::HWFEATURE__CONTAININGCATEGORY:
    {
        ...
        ::am210::model::HwFeatureCategory_ptr _t1 = std::dynamic_pointer_cast
                < ::am210::model::HwFeatureCategory > (_t0);

        ::am210::model::HwFeatureCategory_ptr _old_containingCategory =
        ...
        if (_old_containingCategory && _old_containingCategory != _t0)
        {
            ...
            _old_containingCategory->::ecore::EObject::_inverseRemove(
                    ::am210::model::ModelPackage::_instance()->getHwFeatureCategory__features(),
                    _this);
        }
