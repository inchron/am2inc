...
/*
 * am210/model/TimeBetaDistribution.hpp
...
#ifndef AM210_MODEL_TIMEBETADISTRIBUTION_HPP
#define AM210_MODEL_TIMEBETADISTRIBUTION_HPP
...
namespace am210
{
    ...
    class EXPORT_AM210_MODEL_DLL TimeBetaDistribution : public virtual ::am210::model::BoundedTimeDistribution
    {
    public:
        ...
        // Attributes
        virtual ::am210::model::PositiveDouble getAlpha () const;
        virtual void setAlpha (::am210::model::PositiveDouble _alpha);

        virtual ::am210::model::PositiveDouble getBeta () const;
        virtual void setBeta (::am210::model::PositiveDouble _beta);
    ...
    protected:
        ...
        ::am210::model::PositiveDouble m_alpha
        {   1.0};

        ::am210::model::PositiveDouble m_beta
        {   1.0};
...
#endif // AM210_MODEL_TIMEBETADISTRIBUTION_HPP
