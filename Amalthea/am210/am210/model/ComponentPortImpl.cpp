...
/*
 * am210/model/ComponentPortImpl.cpp
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am210::model::ModelPackage::COMPONENTPORT__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am210::model::ModelPackage::COMPONENTPORT__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am210::model::ModelPackage::COMPONENTPORT__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am210::model::ModelPackage::COMPONENTPORT__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am210::model::ModelPackage::COMPONENTPORT__TAGS:
    {
        _any = getTags().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am210::model::ModelPackage::COMPONENTPORT__CONTAININGCOMPONENT:
    {
        _any = ::ecore::as < ::ecore::EObject > (getContainingComponent());
    }
        return _any;
    case ::am210::model::ModelPackage::COMPONENTPORT__KIND:
    {
        ::ecorecpp::mapping::any_traits < ::am210::model::InterfaceKind
                > ::toAny(_any, getKind());
    }
        return _any;
    case ::am210::model::ModelPackage::COMPONENTPORT__INTERFACE:
    {
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am210::model::ModelPackage::COMPONENTPORT__INTERFACE:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am210::model::ComponentInterface > (_t0);
        setInterface(_t1);
    }
        return;
...
::ecore::EBoolean ComponentPort::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::am210::model::ModelPackage::COMPONENTPORT__KIND:
        return ::ecorecpp::mapping::set_traits < ::am210::model::InterfaceKind
                > ::is_set(getKind());
    case ::am210::model::ModelPackage::COMPONENTPORT__INTERFACE:
...
::ecore::EClass_ptr ComponentPort::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am210::model::ModelPackage::_instance()->getComponentPort();
    return _eclass;
}
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am210::model::ModelPackage::COMPONENTPORT__CONTAININGCOMPONENT:
    {
        ...
        ::am210::model::Component_ptr _t1 = std::dynamic_pointer_cast
                < ::am210::model::Component > (_t0);

        ::am210::model::Component_ptr _old_containingComponent =
        ...
        if (_old_containingComponent && _old_containingComponent != _t0)
        {
            ...
            _old_containingComponent->::ecore::EObject::_inverseRemove(
                    ::am210::model::ModelPackage::_instance()->getComponent__ports(),
                    _this);
        }
