...
/*
 * am210/model/DiscreteValueConstantImpl.cpp
...
{
    // Supertypes
    ::am210::model::IDiscreteValueDeviation::_initialize();
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am210::model::ModelPackage::DISCRETEVALUECONSTANT__VALUE:
    {
...
::ecore::EClass_ptr DiscreteValueConstant::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am210::model::ModelPackage::_instance()->getDiscreteValueConstant();
    return _eclass;
}
