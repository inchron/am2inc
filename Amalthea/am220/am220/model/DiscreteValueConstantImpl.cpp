...
/*
 * am220/model/DiscreteValueConstantImpl.cpp
...
{
    // Supertypes
    ::am220::model::IDiscreteValueDeviation::_initialize();
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am220::model::ModelPackage::DISCRETEVALUECONSTANT__VALUE:
    {
...
::ecore::EClass_ptr DiscreteValueConstant::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am220::model::ModelPackage::_instance()->getDiscreteValueConstant();
    return _eclass;
}
