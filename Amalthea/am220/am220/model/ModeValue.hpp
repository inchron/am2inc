...
#ifndef AM220_MODEL_MODEVALUE_HPP
#define AM220_MODEL_MODEVALUE_HPP
...
namespace am220
{
    ...
    class EXPORT_AM220_MODEL_DLL ModeValue : public virtual ::am220::model::BaseObject
    {
    public:
        ModeValue();
        ...
        virtual ::am220::model::ModeLiteral_ptr getLiteral ();
        ...
        // References
        virtual ::am220::model::ModeLabel_ptr getLabel () const;
        virtual void setLabel (::am220::model::ModeLabel_ptr _label);
    ...
    protected:
        ...
        std::weak_ptr< ::am220::model::ModeLabel > m_label;
...
#endif // AM220_MODEL_MODEVALUE_HPP
