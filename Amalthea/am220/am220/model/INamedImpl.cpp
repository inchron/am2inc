...
::am220::model::INamed_ptr INamed::getNamedContainer()
{
#if 0
...
return _xifexpression;
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: am220::model::INamed::getNamePrefix";
    /*PROTECTED REGION END*/
}
...
::ecore::EString INamed::getDefaultNameSeparator()
{
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: am220::model::INamed::getDefaultNameSeparator";
    /*PROTECTED REGION END*/
}

::am220::model::Namespace_ptr INamed::getNamespace()
{
#if 0
    // This is the original body of the EOperation as specified in
    // the ecore. If you want to replace it by C++ code, enable
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am220::model::ModelPackage::INAMED__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am220::model::ModelPackage::INAMED__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
...
::ecore::EClass_ptr INamed::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am220::model::ModelPackage::_instance()->getINamed();
    return _eclass;
}
