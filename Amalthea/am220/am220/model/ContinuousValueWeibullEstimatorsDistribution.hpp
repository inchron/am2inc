...
/*
 * am220/model/ContinuousValueWeibullEstimatorsDistribution.hpp
...
#ifndef AM220_MODEL_CONTINUOUSVALUEWEIBULLESTIMATORSDISTRIBUTION_HPP
#define AM220_MODEL_CONTINUOUSVALUEWEIBULLESTIMATORSDISTRIBUTION_HPP

#include <am220/model/dllModel.hpp>
#include <am220/model_forward.hpp>

#include <ecore_forward.hpp>
#include <am220/model/BoundedContinuousValueDistribution.hpp>
...
namespace am220
{
    ...
    class EXPORT_AM220_MODEL_DLL ContinuousValueWeibullEstimatorsDistribution : public virtual ::am220::model::BoundedContinuousValueDistribution
    {
    public:
        ...
        virtual ::am220::model::PositiveDouble getPRemainPromille () const;
        virtual void setPRemainPromille (::am220::model::PositiveDouble _pRemainPromille);
    ...
    protected:
        ...
        ::am220::model::PositiveDouble m_pRemainPromille
        {   1.0};
...
#endif // AM220_MODEL_CONTINUOUSVALUEWEIBULLESTIMATORSDISTRIBUTION_HPP
