...
/*
 * am220/model/ModeLiteralImpl.cpp
...
#include <am220/model/EnumMode.hpp>
...
return _xifexpression;
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: am220::model::ModeLiteral::toString";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am220::model::ModelPackage::MODELITERAL__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am220::model::ModelPackage::MODELITERAL__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am220::model::ModelPackage::MODELITERAL__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am220::model::ModelPackage::MODELITERAL__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am220::model::ModelPackage::MODELITERAL__CONTAININGMODE:
    {
...
::ecore::EClass_ptr ModeLiteral::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am220::model::ModelPackage::_instance()->getModeLiteral();
    return _eclass;
}
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am220::model::ModelPackage::MODELITERAL__CONTAININGMODE:
    {
        ...
        ::am220::model::EnumMode_ptr _t1 = std::dynamic_pointer_cast
                < ::am220::model::EnumMode > (_t0);

        ::am220::model::EnumMode_ptr _old_containingMode = getContainingMode();
        if (_old_containingMode && _old_containingMode != _t0)
        {
            ::ecore::EJavaObject _this = ::ecore::EObject::_this();
            _old_containingMode->::ecore::EObject::_inverseRemove(
                    ::am220::model::ModelPackage::_instance()->getEnumMode__literals(),
                    _this);
        }
