...
#include <am220/model/HwConnection.hpp>
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am220::model::ModelPackage::HWPORT__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__TAGS:
    {
        _any = getTags().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__BITWIDTH:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getBitWidth());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__PRIORITY:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EInt
                > ::toAny(_any, getPriority());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__PORTTYPE:
    {
        ::ecorecpp::mapping::any_traits < ::am220::model::PortType
                > ::toAny(_any, getPortType());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__PORTINTERFACE:
    {
        ::ecorecpp::mapping::any_traits < ::am220::model::PortInterface
                > ::toAny(_any, getPortInterface());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__DELEGATED:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EBoolean
                > ::toAny(_any, isDelegated());
    }
        return _any;
    case ::am220::model::ModelPackage::HWPORT__CONNECTIONS:
    {
...
::ecore::EBoolean HwPort::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::am220::model::ModelPackage::HWPORT__PORTTYPE:
        return ::ecorecpp::mapping::set_traits < ::am220::model::PortType
                > ::is_set(getPortType());
    case ::am220::model::ModelPackage::HWPORT__PORTINTERFACE:
        return ::ecorecpp::mapping::set_traits < ::am220::model::PortInterface
...
::ecore::EClass_ptr HwPort::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am220::model::ModelPackage::_instance()->getHwPort();
    return _eclass;
}
