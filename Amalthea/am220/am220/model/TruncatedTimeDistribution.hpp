...
/*
 * am220/model/TruncatedTimeDistribution.hpp
...
#ifndef AM220_MODEL_TRUNCATEDTIMEDISTRIBUTION_HPP
#define AM220_MODEL_TRUNCATEDTIMEDISTRIBUTION_HPP
...
namespace am220
{
    ...
    class EXPORT_AM220_MODEL_DLL TruncatedTimeDistribution : public virtual ::am220::model::ITimeDeviation
    {
    public:
        ...
        // References
        virtual ::am220::model::Time_ptr getLowerBound () const;
        virtual void setLowerBound (::am220::model::Time_ptr _lowerBound);

        virtual ::am220::model::Time_ptr getUpperBound () const;
        virtual void setUpperBound (::am220::model::Time_ptr _upperBound);
    ...
    protected:
        ...
        ::am220::model::Time_ptr m_lowerBound;

        ::am220::model::Time_ptr m_upperBound;
...
#endif // AM220_MODEL_TRUNCATEDTIMEDISTRIBUTION_HPP
