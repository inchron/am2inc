...
/*
 * am320/model/DiscreteValueIntervalImpl.cpp
        ...
        [[maybe_unused]]std::map< ::ecore::EJavaObject, ::ecore::EJavaObject > _context)
{
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: am320::model::DiscreteValueInterval::validateInvariants";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am320::model::ModelPackage::DISCRETEVALUEINTERVAL__LOWERBOUND:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::ELongObject
                > ::toAny(_any, getLowerBound());
    }
        return _any;
    case ::am320::model::ModelPackage::DISCRETEVALUEINTERVAL__UPPERBOUND:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::ELongObject
...
::ecore::EClass_ptr DiscreteValueInterval::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am320::model::ModelPackage::_instance()->getDiscreteValueInterval();
    return _eclass;
}
