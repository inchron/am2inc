...
/*
 * am320/model/ComponentInstanceImpl.cpp
...
#include <am320/model/ISystem.hpp>
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__TAGS:
    {
        _any = getTags().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__CONTAININGSYSTEM:
    {
        _any = ::ecore::as < ::ecore::EObject > (getContainingSystem());
    }
        return _any;
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__TYPE:
    {
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__CONTAININGSYSTEM:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am320::model::ISystem > (_t0);
    ...
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__TYPE:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am320::model::Component > (_t0);
        setType(_t1);
    }
        return;
...
::ecore::EClass_ptr ComponentInstance::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am320::model::ModelPackage::_instance()->getComponentInstance();
    return _eclass;
}
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am320::model::ModelPackage::COMPONENTINSTANCE__CONTAININGSYSTEM:
    {
        ...
        ::am320::model::ISystem_ptr _t1 = std::dynamic_pointer_cast
                < ::am320::model::ISystem > (_t0);

        ::am320::model::ISystem_ptr _old_containingSystem =
                getContainingSystem();
        if (_old_containingSystem && _old_containingSystem != _t0)
        {
            ::ecore::EJavaObject _this = ::ecore::EObject::_this();
            _old_containingSystem->::ecore::EObject::_inverseRemove(
                    ::am320::model::ModelPackage::_instance()->getISystem__componentInstances(),
                    _this);
        }
