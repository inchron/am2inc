...
/*
 * am320/model/LocalModeLabel.hpp
...
#ifndef AM320_MODEL_LOCALMODELABEL_HPP
#define AM320_MODEL_LOCALMODELABEL_HPP
...
namespace am320
{
    ...
    class EXPORT_AM320_MODEL_DLL LocalModeLabel : public virtual ::am320::model::ReferableBaseObject
    {
    public:
        LocalModeLabel();
        ...
        // References
        virtual ::am320::model::IExecutable_ptr getContainingExecutable () const;
        virtual void setContainingExecutable (::am320::model::IExecutable_ptr _containingExecutable);
        virtual ::am320::model::IExecutable_ptr basicgetContainingExecutable ();
        virtual void basicsetContainingExecutable (::am320::model::IExecutable_ptr _containingExecutable);
    ...
    protected:
        ...
        std::weak_ptr< ::am320::model::IExecutable > m_containingExecutable;
...
#endif // AM320_MODEL_LOCALMODELABEL_HPP
