...
/*
 * am320/model/DiscreteValueConstantImpl.cpp
...
{
    // Supertypes
    ::am320::model::IDiscreteValueDeviation::_initialize();
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am320::model::ModelPackage::DISCRETEVALUECONSTANT__VALUE:
    {
...
::ecore::EClass_ptr DiscreteValueConstant::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am320::model::ModelPackage::_instance()->getDiscreteValueConstant();
    return _eclass;
}
