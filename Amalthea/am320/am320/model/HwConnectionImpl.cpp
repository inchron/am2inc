...
/*
 * am320/model/HwConnectionImpl.cpp
...
#include <am320/model/Tag.hpp>
#include <am320/model/IDiscreteValueDeviation.hpp>
#include <am320/model/DataRate.hpp>
#include <am320/model/HwPort.hpp>
...
void HwConnection::_initialize()
{
    ...
    ::am320::model::HwPathElement::_initialize();
    ::am320::model::ITaggable::_initialize();
...
std::vector< ::am320::model::HwPort_ptr > HwConnection::getPorts()
{
#if 0
    // This is the original body of the EOperation as specified in
    // the ecore. If you want to replace it by C++ code, enable
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: am320::model::HwConnection::getPorts";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::am320::model::ModelPackage::HWCONNECTION__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__TAGS:
    {
        _any = getTags().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__READLATENCY:
    {
        _any = ::ecore::as < ::ecore::EObject > (getReadLatency());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__WRITELATENCY:
    {
        _any = ::ecore::as < ::ecore::EObject > (getWriteLatency());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__DATARATE:
    {
        _any = ::ecore::as < ::ecore::EObject > (getDataRate());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__PORT1:
    {
        _any = ::ecore::as < ::ecore::EObject > (getPort1());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__PORT2:
    {
        _any = ::ecore::as < ::ecore::EObject > (getPort2());
    }
        return _any;
    case ::am320::model::ModelPackage::HWCONNECTION__INTERNAL:
    {
        ...
        [[maybe_unused]] ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::am320::model::ModelPackage::HWCONNECTION__READLATENCY:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am320::model::IDiscreteValueDeviation
                > (_t0);
        setReadLatency(_t1);
    }
        return;
    ...
    case ::am320::model::ModelPackage::HWCONNECTION__DATARATE:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am320::model::DataRate > (_t0);
        setDataRate(_t1);
    }
        return;
    case ::am320::model::ModelPackage::HWCONNECTION__PORT1:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::am320::model::HwPort > (_t0);
        setPort1(_t1);
    }
        return;
    case ::am320::model::ModelPackage::HWCONNECTION__PORT2:
...
::ecore::EClass_ptr HwConnection::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::am320::model::ModelPackage::_instance()->getHwConnection();
    return _eclass;
}
