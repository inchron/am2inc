...
/*
 * amalthea/model/RunnableParameterImpl.cpp
...
#include <amalthea/model/IDependsOn.hpp>
#include <amalthea/model/CustomProperty.hpp>
#include <amalthea/model/DataDependency.hpp>
#include <amalthea/model/Runnable.hpp>
...
void RunnableParameter::_initialize()
{
    ...
    ::amalthea::model::IDependsOn::_initialize();
...
return (_plus + _xifexpression_1);
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: amalthea::model::RunnableParameter::toString";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__CUSTOMPROPERTIES:
    {
        _any = getCustomProperties().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__DEPENDSON:
    {
        _any = ::ecore::as < ::ecore::EObject > (getDependsOn());
    }
        return _any;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__CONTAININGRUNNABLE:
    {
        _any = ::ecore::as < ::ecore::EObject > (getContainingRunnable());
    }
        return _any;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__DIRECTION:
    {
        ::ecorecpp::mapping::any_traits < ::amalthea::model::DirectionType
                > ::toAny(_any, getDirection());
    }
        return _any;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__DATATYPE:
    {
        ...
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__DEPENDSON:
    {
        auto _t0 = ::ecorecpp::mapping::any::any_cast < ::ecore::EObject_ptr
                > (_newValue);
        auto _t1 = ::ecore::as < ::amalthea::model::DataDependency > (_t0);
        setDependsOn(_t1);
    }
        return;
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__DIRECTION:
    {
        ::amalthea::model::DirectionType _t0;
        ::ecorecpp::mapping::any_traits < ::amalthea::model::DirectionType
                > ::fromAny(_newValue, _t0);
        setDirection(_t0);
    }
...
::ecore::EBoolean RunnableParameter::eIsSet(::ecore::EInt _featureID)
{
    ...
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__DIRECTION:
        return ::ecorecpp::mapping::set_traits
                < ::amalthea::model::DirectionType > ::is_set(getDirection());
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__DATATYPE:
...
::ecore::EClass_ptr RunnableParameter::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::amalthea::model::ModelPackage::_instance()->getRunnableParameter();
    return _eclass;
}
        ...
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::amalthea::model::ModelPackage::RUNNABLEPARAMETER__CONTAININGRUNNABLE:
    {
        ...
        ::amalthea::model::Runnable_ptr _t1 = std::dynamic_pointer_cast
                < ::amalthea::model::Runnable > (_t0);

        ::amalthea::model::Runnable_ptr _old_containingRunnable =
        ...
        if (_old_containingRunnable && _old_containingRunnable != _t0)
        {
            ...
            _old_containingRunnable->::ecore::EObject::_inverseRemove(
                    ::amalthea::model::ModelPackage::_instance()->getRunnable__parameters(),
                    _this);
        }
