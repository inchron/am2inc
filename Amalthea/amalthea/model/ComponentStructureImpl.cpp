...
/*
 * amalthea/model/ComponentStructureImpl.cpp
...
#include <amalthea/model/ComponentStructure.hpp>
...
::amalthea::model::ComponentStructure_ptr ComponentStructure::getContainingStructure()
{
#if 0
...
return _xifexpression;
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: amalthea::model::ComponentStructure::getContainingStructure";
    /*PROTECTED REGION END*/
}
...
::ecore::EString ComponentStructure::getDefaultNameSeparator()
{
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: amalthea::model::ComponentStructure::getDefaultNameSeparator";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::amalthea::model::ModelPackage::COMPONENTSTRUCTURE__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::COMPONENTSTRUCTURE__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::COMPONENTSTRUCTURE__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getUniqueName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::COMPONENTSTRUCTURE__STRUCTURETYPE:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getStructureType());
    }
        return _any;
    case ::amalthea::model::ModelPackage::COMPONENTSTRUCTURE__SUBSTRUCTURES:
    {
        _any = getSubStructures().asEListOf< ::ecore::EObject_ptr >();
    }
        return _any;
    case ::amalthea::model::ModelPackage::COMPONENTSTRUCTURE__MEMBEROBJECTS:
    {
...
::ecore::EClass_ptr ComponentStructure::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::amalthea::model::ModelPackage::_instance()->getComponentStructure();
    return _eclass;
}
