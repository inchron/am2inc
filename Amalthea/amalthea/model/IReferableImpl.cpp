...
/*
 * amalthea/model/IReferableImpl.cpp
...
{
    // Supertypes
    ::amalthea::model::INamed::_initialize();
        ...
        [[maybe_unused]]std::map< ::ecore::EJavaObject, ::ecore::EJavaObject > _context)
{
    ...
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    throw "UnsupportedOperationException: amalthea::model::IReferable::validateInvariants";
    /*PROTECTED REGION END*/
}
        ...
        ::ecore::EBoolean /*_resolve*/)
{
    ...
    switch (_featureID)
    {
    case ::amalthea::model::ModelPackage::IREFERABLE__NAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::IREFERABLE__QUALIFIEDNAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::toAny(_any, getQualifiedName());
    }
        return _any;
    case ::amalthea::model::ModelPackage::IREFERABLE__UNIQUENAME:
    {
        ::ecorecpp::mapping::any_traits < ::ecore::EString
...
::ecore::EClass_ptr IReferable::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            ::amalthea::model::ModelPackage::_instance()->getIReferable();
    return _eclass;
}
