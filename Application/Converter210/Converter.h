...
public:
	...
	void work( const am210::model::ProcessPrototype_ptr&,
			   am210::model::ProcessPrototype* );
	...
	std::tuple<std::vector<root::model::EventGraphNode_ptr> /*stimuliSuccessors*/,
		...
		fillEventGraph( const am210::model::AbstractEventChain_ptr& am,
	...
	root::model::ModeGroup_ptr createModeGroup( const am210::model::ModeLabel_ptr& );
	root::model::Counter_ptr createCounter( const am210::model::ModeLabel_ptr& );
