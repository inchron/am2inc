...
void Converter::work( const am320::model::OperatingSystem_ptr& am,
					  am320::model::OperatingSystem* ) {
	if ( _mode == PreOrder ) {
 ...
 * Scheduler.
 */
void Converter::work( const am320::model::InterruptController_ptr& am,
					  am320::model::InterruptController* ) {
	if ( _mode == PreOrder ) {
		if ( auto os = ecore::as<am320::model::OperatingSystem>( am->eContainer() ) ) {
...
void Converter::work( const am320::model::TaskScheduler_ptr& am,
					  am320::model::TaskScheduler* ) {
	if ( _mode == PreOrder ) {
...
//void Converter::work( const am320::model::TaskSchedulingAlgorithm_ptr&,
...
void Converter::work( const am320::model::SchedulerAssociation_ptr& am,
...
void Converter::work( const am320::model::Semaphore_ptr& am, am320::model::Semaphore* ) {
	if ( _mode == PreOrder ) {
