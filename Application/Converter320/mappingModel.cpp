...
void Converter::work( const am320::model::MappingModel_ptr&,
					  am320::model::MappingModel* ) {
	if ( _mode == PreOrder ) {
		/* Nothing to do. */
 ...
 */
void Converter::work( const am320::model::ISRAllocation_ptr& am,
					  am320::model::ISRAllocation* ) {
	if ( _mode == PreOrder ) {
