...
void Converter::work( const am220::model::MappingModel_ptr&,
					  am220::model::MappingModel* ) {
	if ( _mode == PreOrder ) {
		/* Nothing to do. */
 ...
 */
void Converter::work( const am220::model::ISRAllocation_ptr& am,
					  am220::model::ISRAllocation* ) {
	if ( _mode == PreOrder ) {
