...
void Converter::work( const am220::model::OperatingSystem_ptr& am,
					  am220::model::OperatingSystem* ) {
	if ( _mode == PreOrder ) {
 ...
 * Scheduler.
 */
void Converter::work( const am220::model::InterruptController_ptr& am,
					  am220::model::InterruptController* ) {
	if ( _mode == PreOrder ) {
		if ( auto os = ecore::as<am220::model::OperatingSystem>( am->eContainer() ) ) {
...
void Converter::work( const am220::model::TaskScheduler_ptr& am,
					  am220::model::TaskScheduler* ) {
	if ( _mode == PreOrder ) {
...
//void Converter::work( const am220::model::TaskSchedulingAlgorithm_ptr&,
...
void Converter::work( const am220::model::SchedulerAssociation_ptr& am,
...
void Converter::work( const am220::model::Semaphore_ptr& am, am220::model::Semaphore* ) {
	if ( _mode == PreOrder ) {
