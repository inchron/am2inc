...
void Converter::work( const am200::model::MappingModel_ptr&,
					  am200::model::MappingModel* ) {
	if ( _mode == PreOrder ) {
		/* Nothing to do. */
 ...
 */
void Converter::work( const am200::model::ISRAllocation_ptr& am,
					  am200::model::ISRAllocation* ) {
	if ( _mode == PreOrder ) {
